...
class Training:
    ...
    def build_model_feed(self, category, lag, weather_lag, pred_hr):
        ...
        return X, y, X_valid, y_valid, model_name, timeseries_test, load
            ...
            for lag in [72]:
                for pred_hr in [72]:
                    for weather_lag in [6]:
                        X, y, X_valid, y_valid, model_name, timeseries_test, load = self.build_model_feed(category, lag, weather_lag, pred_hr)
